...
description: 'Detect if is a mobile device (phone or tablet) Here&#39;s the checklist we use: - has touch events - has orientation - max width 639px (to be improved) - pointer is coarse'
type: 'Function'
status: 'stable'
since: '1.0.0'
...
<p class="docmap_description">true if is a mobile&comma; false if not</p>
</li>
</ol>
</div>
