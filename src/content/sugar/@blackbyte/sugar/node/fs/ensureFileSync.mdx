---
title: 'ensureFileSync'
namespace: '@blackbyte.sugar.node.fs'
description: 'Ensure that the passed file exists. If not, will be created... (sync)'
type: 'Function'
status: 'stable'
since: '1.0.0'
...
<p class="docmap_description">The file to ensure that it exists&period;&period;&period;</p>
</li>
</ol>
</div>
