...
description: 'Expose two functions named &quot;encrypt&quot; and &quot;decrypt&quot; to process content using the stega algorithm. Delegates to the @vercel/stega package under the hood.'
type: 'Object'
status: 'stable'
since: '1.0.0'
