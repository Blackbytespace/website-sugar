---
title: 'distanceFromElementTopToViewportTop.browser.test.ts'
namespace: '@blackbyte.sugar.js.dom.distance'
description: 'Browser e2e tests for distanceFromElementTopToViewportTop'
type: 'Test'
status: 'stable'
since: '2.0.0'
...
# distanceFromElementTopToViewportTop.browser.test.ts
