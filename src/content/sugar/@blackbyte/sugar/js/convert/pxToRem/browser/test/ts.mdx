---
title: 'pxToRem.browser.test.ts'
namespace: '@blackbyte.sugar.js.convert'
description: 'Browser e2e tests for pxToRem — converts px values to rem using the computed font-size of the root element (document.documentElement).'
type: 'Test'
status: 'stable'
since: '2.0.0'
