---
title: 'copyFile.browser.test.ts'
namespace: '@blackbyte.sugar.js.clipboard'
description: 'Browser e2e tests for copyFile — fetches a URL and copies the resulting blob to the clipboard via the Clipboard API.'
type: 'Test'
status: 'stable'
since: '1.0.0'
