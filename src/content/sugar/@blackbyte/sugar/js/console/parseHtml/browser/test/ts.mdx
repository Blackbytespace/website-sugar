---
title: 'parseHtml.browser.test.ts'
namespace: '@blackbyte.sugar.js.console'
description: 'Browser e2e tests for parseHtml — converts HTML-like tags into ANSI escape sequences suitable for styled console output.'
type: 'Test'
status: 'stable'
since: '2.0.0'
...
<div class="docmap_namespace">@blackbyte.sugar.js.console</div>
