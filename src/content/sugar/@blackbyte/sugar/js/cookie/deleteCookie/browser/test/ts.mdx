---
title: 'deleteCookie.browser.test.ts'
namespace: '@blackbyte.sugar.js.cookie'
description: 'Browser e2e tests for deleteCookie — removes a cookie by setting its max-age to -1 via setCookie.'
type: 'Test'
status: 'stable'
since: '2.0.0'
