...
import 'piccolore';
import { c as createRenderInstruction, r as renderComponent, a as renderTemplate, m as maybeRenderHead, b as addAttribute, F as Fragment, u as unescapeHTML, d as defineScriptVars, e as renderHead, f as renderSlot } from './prerender_4hrfdj80.mjs';
...
const websiteConfig = {
  ...
  welcome: {
    title: "Sugar",
    description: 'The toolkit that you missed...<br />...like <span class="color-accent">a sugar in your coffee!</span>',
  ...
  og: {
    imageUrl: "https://raw.githubusercontent.com/Blackbytespace/sugar/refs/heads/main/assets/blackbyte-sugar-og.png"
  },
  discord: {
...
const $$Main = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$Main;
  return renderTemplate`${renderScript($$result, "/Users/olivier/data/web/blackbyte/monorepo/packages/website-sugar/src/layouts/main.astro?astro&type=script&index=0&lang.ts")} ${renderComponent($$result, "MainLayout", $$Main$1, { "pageTitle": Astro2.props.pageTitle, "websiteConfig": websiteConfig }, { "default": ($$result2) => renderTemplate` ${renderSlot($$result2, $$slots["default"])} ` })}`;
}, "/Users/olivier/data/web/blackbyte/monorepo/packages/website-sugar/src/layouts/main.astro", void 0);
