...
description: 'Expose two function named &quot;encrypt&quot; that you can use to process your content using the sha256 algorithm'
type: 'Object'
status: 'stable'
since: '1.0.0'
...
Expose two function named &quot;encrypt&quot; that you can use to process your content using the sha256 algorithm
</div>
