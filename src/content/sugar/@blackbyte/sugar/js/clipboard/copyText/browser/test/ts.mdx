---
title: 'copyText.browser.test.ts'
namespace: '@blackbyte.sugar.js.clipboard'
description: 'Browser e2e tests for copyText — writes a string to the clipboard via navigator.clipboard.writeText.'
type: 'Test'
status: 'stable'
since: '1.0.0'
