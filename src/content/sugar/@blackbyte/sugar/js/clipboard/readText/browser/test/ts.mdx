---
title: 'readText.browser.test.ts'
namespace: '@blackbyte.sugar.js.clipboard'
description: 'Browser e2e tests for readText — reads plain text from the clipboard via navigator.clipboard.readText.'
type: 'Test'
status: 'stable'
since: '1.0.0'
