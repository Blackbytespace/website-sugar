...
description: 'Enhanced proxy of the Element.querySelectorAll function that let you specify if you want elements that are visible, or even that are in the viewport'
type: 'Function'
status: 'stable'
since: '1.0.0'
...
<ol class="docmap_list">
<li class="docmap_item">
<span class="docmap_default">-</span><span class="docmap_type">Array&rcub;&lt;HTMLElement&gt;</span>
<p class="docmap_description">The founded elements</p>
</li>
</ol>
</div>
