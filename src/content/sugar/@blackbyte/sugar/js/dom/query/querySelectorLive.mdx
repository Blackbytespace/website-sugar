...
<li class="docmap_item">
<span class="docmap_name">afterFirst</span><span class="docmap_default">-</span> <span class="docmap_type">Function</span>
...
<p class="docmap_description">If true, the selector will be searched inside elements with the "s-query-selector-live-scope" attribute as scopes</p>
</li>
<li class="docmap_item">
...
<li class="docmap_item">
<span class="docmap_name">when</span><span class="docmap_default">-</span> <span class="docmap_type">TWhenTrigger&vert;string</span>
...
<li class="docmap_item">
<span class="docmap_name">disconnectedCallback</span><span class="docmap_default">-</span> <span class="docmap_type">Function</span>
