---
title: 'whenVideoReady'
namespace: '@blackbyte.sugar.js.dom.when'
description: 'Wait until the passed video is ready to play. It checks if the video metadata has been loaded, and if not it waits for the `loadedmetadata` event.'
type: 'Function'
status: 'stable'
since: '1.0.0'
...
<p class="docmap_description">The video to check the ready state</p>
</li>
</ol>
</div>
...
<p class="docmap_description">The promise that will be resolved when the video is ready to play</p>
</li>
</ol>
</div>
