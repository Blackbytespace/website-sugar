---
title: 'getCookie.browser.test.ts'
namespace: '@blackbyte.sugar.js.cookie'
description: 'Browser e2e tests for getCookie — reads and JSON-parses a cookie value from document.cookie by name.'
type: 'Test'
status: 'stable'
since: '2.0.0'
