---
title: 'pxToEm.browser.test.ts'
namespace: '@blackbyte.sugar.js.convert'
description: 'Browser e2e tests for pxToEm — converts px values to em using the computed font-size of a reference element.'
type: 'Test'
status: 'stable'
since: '2.0.0'
