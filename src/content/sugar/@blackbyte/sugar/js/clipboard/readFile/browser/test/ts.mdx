---
title: 'readFile.browser.test.ts'
namespace: '@blackbyte.sugar.js.clipboard'
description: 'Browser e2e tests for readFile — reads clipboard contents as a ClipboardItems array via navigator.clipboard.read.'
type: 'Test'
status: 'stable'
since: '1.0.0'
