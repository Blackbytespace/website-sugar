---
title: 'distanceFromElementTopToViewportTop'
namespace: '@blackbyte.sugar.js.dom.distance'
description: 'This function take an element as parameter and returns you to distance it has from the element top to the viewport top in pixels'
type: 'Function'
status: 'stable'
since: '1.0.0'
