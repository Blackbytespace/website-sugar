---
title: 'setCookie.browser.test.ts'
namespace: '@blackbyte.sugar.js.cookie'
description: 'Browser e2e tests for setCookie — sets a browser cookie with optional configuration (path, expires, max-age, secure, samesite, httpOnly).'
type: 'Test'
status: 'stable'
since: '2.0.0'
