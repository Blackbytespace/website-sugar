...
description: 'Generate a unique identifier string using UUID v4. Works using the [uuid](https://www.npmjs.com/package/uuid) npm package under the hood.'
type: 'Function'
status: 'stable'
since: '1.0.0'
...
<p class="docmap_description">A UUID v4 string &lpar;36 characters with dashes&rpar;</p>
</li>
</ol>
</div>
