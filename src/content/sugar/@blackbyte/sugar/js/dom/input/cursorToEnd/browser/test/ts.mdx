---
title: 'cursorToEnd.browser.test.ts'
namespace: '@blackbyte.sugar.js.dom.input'
description: 'Browser e2e tests for cursorToEnd'
type: 'Test'
status: 'stable'
since: '2.0.0'
...
<div class="docmap_namespace">@blackbyte.sugar.js.dom.input</div>
