---
title: 'copyElement.browser.test.ts'
namespace: '@blackbyte.sugar.js.clipboard'
description: 'Browser e2e tests for copyElement — verifies DOM selection and clipboard copy behaviour using real browser APIs (Selection, Range, execCommand).'
type: 'Test'
status: 'stable'
since: '1.0.0'
