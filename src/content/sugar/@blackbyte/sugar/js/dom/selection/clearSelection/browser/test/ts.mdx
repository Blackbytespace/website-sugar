---
title: 'clearSelection.browser.test.ts'
namespace: '@blackbyte.sugar.js.dom.selection'
description: 'Browser e2e tests for clearSelection'
type: 'Test'
status: 'stable'
since: '2.0.0'
...
# clearSelection.browser.test.ts
...
<div class="docmap_namespace">@blackbyte.sugar.js.dom.selection</div>
