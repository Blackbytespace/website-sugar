...
description: 'This function allows you to copy to the clipboard the passed dom node element with his style'
type: 'Function'
status: 'stable'
since: '1.0.0'
...
<p class="docmap_description">The dom node element to copy to the clipboard</p>
</li>
</ol>
</div>
